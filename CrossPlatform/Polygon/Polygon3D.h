...
namespace CrossPlatform {
	...
	public:
		...
		Polygon3D(int numOfPtr, VertexIndexs* vertexPointerList, int numOfVertex, Vector3f* vertexList,int numOfNormal, Vector3f* normalList, int numofCoordinate, Vector2f* textureCoordinate, const xg::Guid& material);
